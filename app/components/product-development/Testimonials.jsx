...
const stories = [
  {
    id: "diggs",
    cover: "/product-development/testimonials/home_diggs.webp",
    video: null,
    logo: "/product-development/testimonials/home_diggs_logo.webp",
    logoWidth: 179,
    logoHeight: 41,
    company: "DIGGS",
  ...
  {
    id: "finastra",
    cover: "/product-development/testimonials/home_finastra.webp",
    video: null,
    logo: "/product-development/testimonials/home_finastra_logo.webp",
    logoWidth: 289,
    logoHeight: 41,
    company: "FINASTRA",
  ...
  {
    id: "hawke",
    cover: "/product-development/testimonials/home_hawke.webp",
    video: null,
    logo: "/product-development/testimonials/home_hawke_logo.webp",
    logoWidth: 179,
    logoHeight: 41,
    company: "Hawke Media",
      ...
      {showHeadline && (
        <div className="tm-headline-row">
          ...
          <div className="tm-award">
            <img
              src="/product-development/testimonials/awards.svg"
              width="346"
              height="89"
              alt="ClickUp awards"
              loading="lazy"
