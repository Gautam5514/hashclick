const projectReviews = [
  ["Gautam P.", "It has revolutionized the way our teams communicate and keep track of our work.\n\nNow we're not using different systems to keep track of updates on campaigns and activities."],
  ["Sagar P.", "Hashboard has the biggest and best set of features I have seen in comparable products such as Monday, Asana and Trello.\n\nIt makes adoption so much easier, when each team member can find a view that works for them."],
  ["Chinmayyee R.", "A one stop solution for literally EVERYTHING!"],
  ["Kunal R.", "My life is in Hashboard!\n\nIt's easy to use, has robust features, and makes it really easy to keep every part of my business organized."],
  ["Diksha B.", "The ease of use is absolutely amazing.\n\nHashboard is extremely easy to customize to get the best value out of it."],
  ["Dheeraj H.", "Such a powerful project management tool.\n\nTypically any feature you can think of for project management is part of Hashboard."],
];

const softwareReviews = [
  ["Gautam A.", "Our engineering team uses scrum, while our marketing team uses kanban. Both play nice together in one Hashboard account."],
  ["Abhay P.", "Absolutely by far the best tool in the world for project, task, goal, budget and workflow management—especially for engineering."],
  ["karthik G.", "We no longer have to find wiki pages in Confluence, engineering tickets in Jira, or tables and lists in Notion."],
