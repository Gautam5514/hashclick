...
function FeatureCard([title, body, image]) {
  return <article key={title}>
    ...
    <div className="pm-card-image"><Image src={`/product-development/${image}`} alt={title} width={900} height={680} /></div>
  </article>;
}
  ...
  return <section className="pm-resources"><div className="pm-shell">
    ...
    <div className="pm-res-grid">{posts.map(([title, author, role, art, tone]) => <article key={title}>
      ...
      <div className="pm-res-by">
        {tone === "brand"
          ? <span className="pm-res-avatar pm-res-avatar-brand"><Image src="/product-development/comparison-logo-mark.svg" alt="" width={130} height={155} /></span>
