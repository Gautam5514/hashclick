const projectReviews = [
  ...
  ["Josh P.", "ClickUp has the biggest and best set of features I have seen in comparable products such as Monday, Asana and Trello.\n\nIt makes adoption so much easier, when each team member can find a view that works for them."],
  ["Chinmayyee R.", "A one stop solution for literally EVERYTHING!"],
  ["Britt R.", "My life is in ClickUp!\n\nIt's easy to use, has robust features, and makes it really easy to keep every part of my business organized."],
  ["Oskar B.", "The ease of use is absolutely amazing.\n\nClickUp is extremely easy to customize to get the best value out of it."],
  ["Zack H.", "Such a powerful project management tool.\n\nTypically any feature you can think of for project management is part of ClickUp."],
];

const softwareReviews = [
  ["Jacob A.", "Our engineering team uses scrum, while our marketing team uses kanban. Both play nice together in one ClickUp account."],
  ...
  ["Arvin J.", "ClickUp allows us to break down the pieces of a software engineering project and stay flexible on the granularity required."],
];
...
export default function TeamReviewMarquee({ software = false }) {
  ...
  return <section className="team-reviews"><div className="team-reviews-head"><div className="team-reviews-score"><span>★★★★★</span><p>25,000+ reviews from</p><b>G2</b><i>◈</i><i>➤</i><i>●</i></div><h2>Why {software ? "software teams" : "project managers"} <span>love ClickUp</span></h2></div><div className="team-review-wall"><Row reviews={reviews.slice(0,3)} /><Row reviews={reviews.slice(3)} reverse /></div></section>;
}
