...
function Hero() {
  return <section className="pm-hero">
    <div className="pm-shell pm-hero-grid">
      ...
      <div className="pm-hero-art"><Image src="/operations/hero.png" alt="ClickUp project management workspace" width={3075} height={1800} priority /></div>
    </div>
  </section>;
}
  ...
  return <>
    ...
    <section className="pm-integrations">
      ...
      <div className="pm-marquee">
        ...
        <span className="pm-marquee-badge"><Image src="/operations/comparison-logo-mark.svg" alt="ClickUp" width={130} height={155} className="pm-marquee-mark" /></span>
      </div>
    </section>
