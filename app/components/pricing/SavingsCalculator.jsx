...
export default function SavingsCalculator() {
  ...
  return <section className="savings-section">
    <div className="pricing-container">
      <div className="savings-eyebrow">[ SAVE WITH Hashboard ]</div>
      ...
      <div className="savings-calculator">
        <div className="savings-apps">
          ...
          <div className="savings-mark"><i/><Image src="/pricing/apps/clickup.svg" alt="Hashboard" width={44} height={44}/><i/></div>
        </div>
        <div className="replace-card">
          ...
          {hasEnough ? <>
            ...
            <div className="clickup-cost">HASHBOARD FOR {people} {people === 1 ? "USER" : "USERS"} = ${clickupAnnual.toLocaleString()} / YEAR</div>
            <div className="saving-result"><div><span>Cost savings</span><strong>${savings.toLocaleString()}</strong></div><p>Hashboard can save a {people} person company ${savings.toLocaleString()} per year compared to the non-enterprise price of your apps.</p></div>
          </> : <p className="replace-hint">Select at least 2 apps to calculate your savings</p>}
          <Link href="/signup">Start saving with Hashboard today<ChevronRight size={16}/></Link>
